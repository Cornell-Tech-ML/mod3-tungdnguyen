...
def njit(fn: Fn, **kwargs: Any) -> Fn:
    """Make a function JIT compiled"""
    return _njit(inline="always", **kwargs)(fn)  # type: ignore

def stride_aligned(a_strides: Strides, b_strides: Strides, a_shape: Shape, b_shape: Shape) -> bool:
    """Check if two tensors are stride-aligned."""
    return (len(a_strides) == len(b_strides) 
...
stride_aligned = njit(stride_aligned)
